...
class TimeDuration implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets value
     *
     * @param int|null $value An amount of time, as measured by the time-measurement units specified in the unit field.
     *
     * @return self
     */
